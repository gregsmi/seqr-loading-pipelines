...
download VEP cache
mkdir -p ${PATH_ROOT}/vep_data/homo_sapiens
cd ${PATH_ROOT}/vep_data
...
cd ${PATH_ROOT}/vep_data/homo_sapiens
...
mkdir -p "${PATH_ROOT}/vep_data/loftee_data/GRCh${BUILD_VERSION}"
cd "${PATH_ROOT}/vep_data/loftee_data/GRCh${BUILD_VERSION}"
...
mkdir -p "${PATH_ROOT}/seqr-reference-data/GRCh${BUILD_VERSION}/${REF_DATA_HT}"
mkdir -p "${PATH_ROOT}/seqr-reference-data/GRCh${BUILD_VERSION}/${CLINVAR_HT}"
cd "${PATH_ROOT}/seqr-reference-data/GRCh${BUILD_VERSION}"
